	 	 		 ...
	 	 		 <div class="card shadow-sm" style="border-radius: 20px; background-color:#fde1ff; color:black;">
	 	 		 	 <div class="card-body">
	 	 		 	 	...
	 	 		 	 	<input type="hidden" name="login">
	 	 		 	 	 ...
	 	 		 	 	 <a href="javascript:void(0)" class="registerhere"  style="text-decoration: none">Don't have an Account?<br>Register here.</a>
 	 	 		 	 	 	 </form>
								...
								<button type="button" class="btn btn-secondary text-light mt-2 back" style="font-size: 14px"> Already have an account</button>
								</div>
