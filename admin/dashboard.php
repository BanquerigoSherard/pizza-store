...
<body style="background-color: rgb(249, 234, 255)">
    <div class="wrapper">
        ...
        <nav class="sidenav shadow">
            <div class="userinfo">
                <img src="../img/undraw_male_avatar_323b.svg" class="img-thumbnnail shadow"
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card mt-3 shadow-sm">
                                <div class="card-body">
                                    <h5 class="text-primary text-secondary"
                                        style="font-weight:bolder;font-family: 'Courgette', cursive;">EB Fashion</h5>
                            ...
                            <div class="card mt-3 shadow-sm">
                                <div class="card-body">
                                    <span style="font-weight: bolder;font-size: 25px">
                                        <div class="clock">
                                            <div class="displayoutside"></div>
                                        </div>
                                    </span>
                                    <span
                                        style=""><?php echo  date('F j,  Y ',strtotime(date('Y-m-d H:i:s'))); ?></span>
